...
```javascript JavaScript
const years = await fetch('http://127.0.0.1:5000/api/years')
  .then(r => r.json());
```

```python Python
import requests
years = requests.get('http://127.0.0.1:5000/api/years').json()
```
</CodeGroup>
...
```javascript JavaScript
const months = await fetch('http://127.0.0.1:5000/api/years/2026/months')
  .then(r => r.json());
```

```python Python
import requests
months = requests.get('http://127.0.0.1:5000/api/years/2026/months').json()
```
</CodeGroup>
...
```javascript JavaScript
const days = await fetch('http://127.0.0.1:5000/api/years/2026/months/3/days')
  .then(r => r.json());
```

```python Python
import requests
days = requests.get('http://127.0.0.1:5000/api/years/2026/months/3/days').json()
```
</CodeGroup>
...
<ResponseField name="hasPhotos" type="boolean">
...
<ResponseField name="moodEmoji" type="string">
